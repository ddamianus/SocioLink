...
function App() {
  ...
  const handleSync = async () => {
    ...
    console.log('=== DATA MINIMIZATION PAYLOAD ===');
    console.log(`Počet záznamů: ${payload.length}`);
    console.log('Odesílané data (bez jména, příjmení, data narození):');
    console.table(payload);
    console.log('=== KONEC PAYLOADU ===');

    setTimeout(() => {
      setSyncing(false);
      alert(`Synchronizace dokončena.\n${payload.length} záznamů bylo připraveno pro odeslání na KÚ MSK.`);
    }, 1000);
  };
    ...
    <div className="min-h-screen bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 mb-8">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between bg-gray-800/50 p-4 rounded-2xl border border-gray-700/50 shadow-inner">
